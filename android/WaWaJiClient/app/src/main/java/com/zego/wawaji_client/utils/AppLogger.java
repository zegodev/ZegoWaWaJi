...
public class AppLogger {
    ...
    static private String DEFAULT_LOG_FILE_NAME = "wawaji_client_business.log";
    static private String DEFAULT_LOG_FILE_NAME_BAK = "wawaji_client_business_2.log";

    static private String FORMATTER_LOG_FILE_NAME = "wawaji_client_%s.log";
    static private String FORMATTER_LOG_FILE_NAME_BAK = "wawaji_client_%s_2.log";
    ...
    private void initLogFile() {
        ...
        if (!OSUtils.isMainProcess(ZegoApplication.sApplicationContext)) {
